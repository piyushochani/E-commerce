...
const SellerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await sellerService.login(formData);
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              <label htmlFor="seller_password" className="block text-sm font-medium text-gray-700 mb-2">
                Password
              </label>
              <input
                id="seller_password"
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-gray-600">Are you a customer?</p>
